  ...
  return (
    <div className="about pr">
        ...
        <div className="about-content">
            <div className="title ta-c title title3">why us ?</div>
            <div className="mt-28">
                <div className="df justify-center w-full">
                    <div className="element df-c ta-c ai-c">
                ...
                <div className="df justify-around mt-16 w-full">
                    <div className="element df-c ta-c ai-c">
