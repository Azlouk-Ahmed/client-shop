            ...
            <div className="mt-20">
                <div className="df justify-center w-full">
                    ...
                    <div className="product-img !w-20 !h-16">
                        ...
                        <img src="/img/honeyicon.png" className="beeicon prod" />
                    </div>
                ...
                <div className="df jc-sb sm-df-c sm-w-full mt-16">
                    ...
                    <div className="product-img !w-20 !h-16">
                        <img src="/img/polygon.png" alt="" className="poly" srcSet="" />
                        <img src="/img/purchase.png" className="beeicon prod" />
                    </div>
                    ...
                    <div className="product-img !w-20 !h-16">
                        <img src="/img/polygon.png" alt="" className="poly" srcSet="" />
                        <img src="/img/quality.png" className="beeicon prod" />
                    </div>
                ...
                <div className="df justify-around sm-df-c mt-16 w-full">
                    ...
                    <div className="product-img !w-20 !h-16">
                        <img src="/img/polygon.png" alt="" className="poly" srcSet="" />
                        <img src="/img/delivery-man.png" className="beeicon prod" />
                    </div>
                    ...
                    <div className="product-img !w-20 !h-16">
                        <img src="/img/polygon.png" alt="" className="poly" srcSet="" />
                        <img src="/img/beeicon.png" className="beeicon prod" />
                    </div>
